            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('register')); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="firstName" type="text"
                                    ...
                                    name="firstName" value="<?php echo e(old('firstName')); ?>" required autofocus>
                        ...
                        <div class="form-group row">
                            <label for="nickName"
                                class="col-md-4 col-form-label text-md-right"><?php echo e(__('Nickname')); ?></label>

                            <div class="col-md-6">
                                <input id="nickName" type="text"
                                    class="form-control<?php echo e($errors->has('nickName') ? ' is-invalid' : ''); ?>"
                                    name="nickName" value="<?php echo e(old('nickName')); ?>" required autofocus>
